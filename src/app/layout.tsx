...
export const metadata: Metadata = {
  title: "Joule Ventures | VC for American & Israeli Founders",
  description: "Venture capital firm connecting American and Israeli founders with capital, network, and expertise in Atlanta. Invest in deep-tech, enterprise software, fintech, and biotech.",
  keywords: "venture capital, VC, founders, investment, tech, startup, American founders, Israeli founders, Atlanta",
  metadataBase: new URL("https://jouleventures.com"),
  alternates: {
    canonical: "https://jouleventures.com"
  },
  openGraph: {
    title: "Joule Ventures | Bridging Innovation Ecosystems",
    description: "Backing exceptional founders across the US and Israel with capital, network, and strategic expertise.",
    url: "https://jouleventures.com",
    siteName: "Joule Ventures",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766024361753-xwbb7uwr.jpg",
        alt: "Joule Ventures - VC for American and Israeli Founders"
      }
    ]
  },
  twitter: {
    ...
    title: "Joule Ventures | VC for American & Israeli Founders",
    description: "Venture capital firm connecting exceptional founders with capital and strategic expertise.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34YrpHTNyoPHUh85bjA10KHfDge/uploaded-1766024361753-xwbb7uwr.jpg"]
  },
  robots: {
    index: true,
    follow: true
